...
public final class Logger {
    ...
    public class func devLog(_ object: Any?, level: Level = .debug, method: OutputMethod = .nslog, filename: String = #file, line: Int = #line, funcName: String = #function) {
        #if DEBUG
        log(object, level: level, method: method, filename: filename, line: line, funcName: funcName)
        #endif
    }
    
    public class func log(_ object: Any?, level: Level = .debug, method: OutputMethod = .nslog, filename: String = #file, line: Int = #line, funcName: String = #function) {
